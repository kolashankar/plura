...
import { UserFormTable } from './_components/user-form-table'
import { CreateUserFormDialog } from './_components/create-user-form-dialog'
import { FormSubmissionAnalytics } from './_components/form-submission-analytics'
...
export default function SubAccountAutomationFormsPage() {
    ...
    <div className=\"space-y-6 p-6\">
      ...
      <div className=\"flex items-center justify-between\">
        <div>
          ...
          <p className=\"text-gray-600 dark:text-gray-300 mt-2\">
            Create and manage custom forms with automated workflows
          </p>
        </div>
      ...
      <Tabs value={selectedTab} onValueChange={setSelectedTab} className=\"space-y-6\">
        ...
        <TabsContent value=\"forms\" className=\"space-y-6\">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage your custom forms and their automation workflows
              </CardDescription>
            </CardHeader>
            <CardContent>
              <UserFormTable
        ...
        <TabsContent value=\"analytics\" className=\"space-y-6\">
          <FormSubmissionAnalytics forms={forms} subaccountId={subaccountId} />
        </TabsContent>
      </Tabs>
