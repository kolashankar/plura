...
const SettingsTab = (props: Props) => {
  ...
  return (
    <Accordion
      type="multiple"
      className="w-full"
      defaultValue={['Custom', 'Typography', 'Dimensions', 'Decorations', 'Flexbox', 'Background', 'Animation', 'Advanced']}
    >
      <AccordionItem
        value="Custom"
        className="px-6 py-0  "
          ...
          <div className="flex gap-4">
            <div>
              ...
              >
                ...
                <SelectContent>
                  <SelectGroup>
                    <SelectLabel>Background Size</SelectLabel>
            ...
            <div>
              ...
              >
                ...
                <SelectContent>
                  <SelectGroup>
                    <SelectLabel>Background Repeat</SelectLabel>
      ...
      >
        ...
        <AccordionContent className="flex flex-col gap-2">
          <div className="flex flex-col gap-2">
            <Label className="text-muted-foreground">Transition Duration</Label>
            <Input
              id="transitionDuration"
              onChange={handleOnChanges}
              value={state.editor.selectedElement.styles.transitionDuration}
              placeholder="0.3s"
            />
          </div>
          <div className="flex flex-col gap-2">
            <Label className="text-muted-foreground">Animation Name</Label>
            <Select
              onValueChange={(e) =>
                handleOnChanges({
                  target: {
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <Input
                id="animationDelay"
                onChange={handleOnChanges}
                value={state.editor.selectedElement.styles.animationDelay}
                placeholder="0s"
              />
            </div>
          </div>
        ...
        <AccordionContent className="flex flex-col gap-2">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Slider
              ...
              defaultValue={[
                parseFloat(state.editor.selectedElement.styles.opacity || '1') * 100,
              ]}
              max={100}
              step={1}
            />
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <Input
                id="filter"
                onChange={handleOnChanges}
                value={state.editor.selectedElement.styles.filter}
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              ...
              <SelectContent>
                <SelectGroup>
                  <SelectLabel>Cursor Types</SelectLabel>
