...
const IndividualPageId = async ({ params, searchParams }: Props) => {
  let currency = 'USD'
  let sessions
  ...
  if (individualDetails.connectAccountId) {
    const response = await stripe.accounts.retrieve({
      stripeAccount: individualDetails.connectAccountId,
    })
          ...
          <div className="absolute -top-10 -left-10 right-0 bottom-0 z-30 flex items-center justify-center backdrop-blur-md bg-background/50">
            <Card>
              <CardHeader>
                ...
                <Link
                  href={`/Individual/${individualDetails.id}/launchpad`}
...
export default IndividualPageId
