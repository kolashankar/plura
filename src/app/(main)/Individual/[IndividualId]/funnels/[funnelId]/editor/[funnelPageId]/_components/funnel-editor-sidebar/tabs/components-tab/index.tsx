  ...
  const elementCategories = {
    ...
    advanced: [
      ...
      },
      {
        ...
        content: [{ tabs: [{ title: 'Tab 1', content: 'Content 1' }, { title: 'Tab 2', content: 'Content 2' }] }],
      ...
      },
      {
        ...
        type: 'modal',
        Component: <Square size={20} />,
        content: [{ title: 'Modal Title', content: 'Modal content here...' }],
        styles: {},
      },
      {
        id: 'breadcrumb',
        ...
        content: [{ items: ['Home', 'Category', 'Product'] }],
        styles: { display: 'flex', gap: '8px', fontSize: '14px' },
      },
      {
        id: 'pagination',
        name: 'Pagination',
        type: 'pagination',
        Component: <MoreHorizontal size={20} />,
      ...
      },
      {
        ...
        name: 'Alert',
        type: 'alert',
        Component: <AlertTriangle size={20} />,
        content: [{ message: 'This is an alert message', type: 'warning' }],
        styles: { padding: '12px', borderRadius: '4px', backgroundColor: '#fff3cd', color: '#856404' },
      },
      {
        id: 'badge',
        name: 'Badge',
        type: 'badge',
        Component: <Gift size={20} />,
        content: [{ text: 'New', color: 'blue' }],
        styles: { padding: '4px 8px', borderRadius: '12px', fontSize: '12px', fontWeight: 'bold' },
      },
      {
        id: 'avatar',
        name: 'Avatar',
        ...
        content: [{ src: '/avatar.jpg', alt: 'User Avatar', fallback: 'U' }],
    ...
    <>
      ...
      >
        ...
        <AccordionItem
          ...
          className="px-6 py-0 border-y-[1px]"
        >
          <AccordionTrigger className="!no-underline">E-commerce</AccordionTrigger>
          <AccordionContent className="flex flex-wrap gap-2 ">
